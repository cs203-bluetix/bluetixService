...
//	}
    ...
    List<Ticket> getTicketByEventSessionId(@PathVariable Long event_id, @PathVariable Long session_id) {
        return ticketService.findByEventSessionId(event_id, session_id);
    }
